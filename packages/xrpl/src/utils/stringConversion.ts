import { stringToHex, hexToString } from '@shichengsh001/isomorphic/utils'
 ...
 *
 * @deprecated use `@shichengsh001/isomorphic/utils`'s `stringToHex`
 *
 * @category Utilities
 */
 ...
 *
 * @deprecated use `@shichengsh001/isomorphic/utils`'s `hexToString`
 *
 * @category Utilities
 */
